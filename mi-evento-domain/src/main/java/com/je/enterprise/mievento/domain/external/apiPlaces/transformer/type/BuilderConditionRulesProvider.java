...
public class BuilderConditionRulesProvider {
	...
	public static  Map<ProviderType, List<ConditionRuleProviderKeyWord>> getRules(){
		...
		rulesByProvider.put(ProviderType.BAT_MITZVA_HALL, Arrays.asList(ConditionRuleProviderKeyWord.AND_BAT_HALL,ConditionRuleProviderKeyWord.AND_BAT_HALL_2,ConditionRuleProviderKeyWord.OR_BAT_HALL_3));
