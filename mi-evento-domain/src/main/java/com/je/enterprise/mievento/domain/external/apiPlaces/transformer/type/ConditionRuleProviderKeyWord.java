...
public enum ConditionRuleProviderKeyWord {
	...
	AND_CAT_3(Pair.of("keyword.catering","keyword.birthday")),
	...
	AND_BIRTH_HALL(Pair.of("keyword.hall","keyword.birthday")),
	...
	AND_BAT_HALL_2(Pair.of("keyword.hall","keyword.mitzva.2")),
	...
	AND_CAKE_2(Pair.of("keyword.cake","keyword.birthday")),
	...
	AND_VID_3(Pair.of("keyword.video","keyword.birthday")),
